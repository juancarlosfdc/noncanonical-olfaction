...
def run_optimization(N, n, M, sigma_c, output_dir): 
    P = 1000
    ...
    Ws, ents, losses = natural_gradient_dual_space(500, W_init, os.cs, key, lambda * args: - os.log_det_sigma(*args), 1, os, phi, psi)
...
if __name__ == '__main__':
    ...
    rho = run_optimization(args.N, args.n, args.M, args.sigma, args.output_dir)

    with open(args.results_file, "a") as f:
        f.write(f"{args.N}\t{args.n}\t{args.M}\t{args.sigma}\t{rho}\n")